...
export default function ProjectsPage() {
  return (
    <div className="max-w-5xl mx-auto px-6 py-16">
      ...
      {/* Personal Projects */}
      <div className="mb-16">
        <h2 className="text-xl font-semibold mb-6">Personal Projects</h2>
        <div className="grid md:grid-cols-2 gap-4">
          {projects.map((project) => (
            <div key={project.id} className="p-5 rounded-xl border border-border bg-card hover:border-primary/30 hover:shadow-lg transition-all group">
      ...
      <div>
        <h2 className="text-xl font-semibold mb-6">Open Source Contributions</h2>
        <div className="grid md:grid-cols-2 gap-4">
          {contributions.map((contrib) => (
            <a
              ...
              className="p-5 rounded-xl border border-border bg-card hover:border-primary/30 hover:shadow-lg transition-all group"
            >
              <div className={`w-full h-2 rounded-full bg-gradient-to-r ${contrib.gradient} mb-4`} />
              <div className="flex items-center justify-between mb-2">
                <h3 className="font-semibold group-hover:text-primary transition-colors">{contrib.project}</h3>
                <span className="text-xs px-2 py-1 rounded-full bg-yellow-500/10 text-yellow-500 font-medium">⭐ {contrib.stars}</span>
              </div>
